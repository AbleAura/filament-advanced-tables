...
class FilamentAdvancedTablesPlugin implements Plugin
{
    ...
    protected bool $hasUserViewsResource     = false;
    ...
    public function boot(Panel $panel): void
    {
        ...
        $panel->renderHook(
            ...
            function (): string {
                ...
                $usesTrait = collect(class_uses_recursive($livewire))
                ...
                return view('filament-advanced-tables::components.favorites-bar-hook', [
                    'livewire' => $livewire,
                ])->render();
            }
        );
    ...
    public function userViews(bool $condition = true): static            { $this->hasUserViews = $condition; return $this; }
    public function presetViews(bool $condition = true): static          { $this->hasPresetViews = $condition; return $this; }
    public function favoritesBar(bool $condition = true): static         { $this->hasFavoritesBar = $condition; return $this; }
    public function quickSave(bool $condition = true): static            { $this->hasQuickSave = $condition; return $this; }
    public function viewManager(bool $condition = true): static          { $this->hasViewManager = $condition; return $this; }
    public function managedDefaultViews(bool $condition = true): static  { $this->hasManagedDefaultViews = $condition; return $this; }
    public function multiSort(bool $condition = true): static            { $this->hasMultiSort = $condition; return $this; }
    public function quickFilters(bool $condition = true): static         { $this->hasQuickFilters = $condition; return $this; }
    public function advancedSearch(bool $condition = true): static       { $this->hasAdvancedSearch = $condition; return $this; }
    public function advancedFilterBuilder(bool $condition = true): static{ $this->hasAdvancedFilterBuilder = $condition; return $this; }
    public function userViewsResource(bool $condition = true): static    { $this->hasUserViewsResource = $condition; return $this; }
    public function loadingSkeleton(bool $condition = true): static      { $this->hasLoadingSkeleton = $condition; return $this; }
    public function theme(string $theme): static                         { $this->theme = $theme; return $this; }
    public function userModel(string $model): static                     { $this->userModel = $model; return $this; }
    public function authGuard(string $guard): static                     { $this->authGuard = $guard; return $this; }
    public function requireApproval(bool $condition = true): static      { $this->approvalRequired = $condition; return $this; }
    public function allowPublicViews(bool $condition = true): static     { $this->allowPublicViews = $condition; return $this; }
